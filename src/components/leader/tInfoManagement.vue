<template>
  <div class="wrapper">
    <!-- 指导老师信息导入 -->
    <el-button slot="trigger" size="small" type="primary">添加信息</el-button>
    <el-upload
      class="upload-demo"
      ref="upload"
    ...
    <el-table :data="tableData" height="250" border style="width: 100%" class="box-table">
      <el-table-column align="center" prop="id" label="工号" width="180"></el-table-column>
      ...
      <el-table-column align="center" prop="professionRank" label="职称" width="180"></el-table-column>
      <el-table-column align="center" prop="degree" label="学位" width="180"></el-table-column>
