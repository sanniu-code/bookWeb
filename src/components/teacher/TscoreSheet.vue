<template>
  <div class="wrapper">
    <!-- 上传成绩评定表 -->
    <el-button type="primary" size="small" @click="dialog">上传成绩评定表</el-button>
    ...
    >
      <el-form :model="form">
        <el-form-item label="学生姓名 :" :label-width="formLabelWidth">
          <el-select v-model="form.stuName" placeholder="这是谁的成绩评定表呢" :disabled="readonly">
        ...
        <el-form-item label="选择文件 :" :label-width="formLabelWidth">
          ...
          >
            <el-button slot="trigger" size="small" type="primary" :disabled="btndisabled">上传成绩评定表</el-button>
          </el-upload>
        </el-form-item>
      </el-form>
